const FIXED_FESTIVALS = {
  ...
  // Independence Day
  "10-02": "republic",
  // Gandhi Jayanti (Patriotic theme)
  "12-25": "christmas"
};
const VARIABLE_FESTIVALS = {
  ...
  // February
  "2026-02-14": "vasant",
  // Vasant Panchami (Overlaps with Valentine's, favored for India)
  "2026-02-17": "shivaratri",
  // Maha Shivaratri
  // March
  "2026-03-25": "holi",
  // April
  "2026-04-10": "eid",
  // Eid-ul-Fitr / Ugadi (Shared date in user list)
  ...
  // Krishna Janmashtami
  // October
  "2026-10-03": "navaratri",
  // Start
  "2026-10-04": "navaratri",
  // Durga Puja
  ...
  "2026-11-01": "diwali",
  "2026-11-03": "harvest",
  // Chhath Puja (Sun/River -> Harvest theme fits well with gold/orange)
  // December
  "2026-12-25": "christmas"
};
function getFestivalThemeId(date) {
