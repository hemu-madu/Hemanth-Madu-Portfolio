...
export default function Quotes() {
    return (
        <section id="quotes" className="py-20 relative bg-neu-light dark:bg-neu-dark transition-colors duration-300">
            <div className="container-custom">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {quotes.map((quote, index) => (
                        ...
                        >
                            <ScratchReveal width={undefined} height={undefined} className="w-full h-full">
